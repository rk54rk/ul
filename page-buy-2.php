...
if ($_SERVER['REQUEST_METHOD'] == 'POST' AND isset($_FILES['image']) AND isset($_FILES['thumbnail']) ) {
  ...
  if( $_FILES['image']['size'] < $max_file_size && $_FILES['thumbnail']['size'] < $max_file_size){
    ...
    <div id="add-ad-2"> 
        ...
        <br>
      <div style="font-size:11px">Please confirm the preview of your ad and finish the payment. Your ad will be posted once we receive confirmation from Paypal.</div>
